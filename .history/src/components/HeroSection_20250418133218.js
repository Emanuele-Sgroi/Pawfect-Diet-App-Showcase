  ...
  return (
    ...
    >
      ...
      <div className="z-20 flex flex-col items-center">
        ...
        />
        <h1 className="text-8xl chewy-font font-bold text-center text-secondary white-outline">
          Pawfect Diet
        </h1>
        <h2 className="mt-4 font-extrabold text-[22px] text-secondary max-w-[650px] text-center">
