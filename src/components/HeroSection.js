  ...
  return (
    ...
    >
      ...
      <div className="z-20 flex flex-col items-center">
        ...
        />
        <h1 className="max-[500px]:text-[39px] text-6xl md:text-8xl chewy-font font-bold text-center text-secondary white_outline">
          Pawfect Diet
        </h1>
        <h2 className="mt-4 font-extrabold text-[18px] sm:text-[22px] max-w-[650px] text-center">
          Advancing Canine Nutrition with AI-Driven Personalised Solutions in a
          Mobile Application
        </h2>
        <div className="bg-white w-full h-px max-w-[450px] my-6" />
        <p className="text-[16px] sm:text-[20px] max-w-[650px] text-center text-secondary white_outline">
          A Computer Science Dissertation Project by{" "}
          <a
