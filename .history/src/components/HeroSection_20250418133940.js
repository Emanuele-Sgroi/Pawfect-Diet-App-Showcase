  ...
  return (
    ...
    >
      ...
      <div className="z-20 flex flex-col items-center">
        ...
        <h2 className="text-[20px] max-w-[650px] text-center text-secondary white_outline ">
          A Computer Science Disertation Project by{" "}
          <span className="font-bold">Emanuele Sgroi</span>
        </h2>
      </div>
